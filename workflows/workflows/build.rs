...
use walkdir::WalkDir;
use warpish_workflows_types::Workflow;
...
/// ```ignore
/// use warpish_workflows_metadata::*;
...
fn write_workflow(workflow: Workflow, file_name: &str) -> Result<()> {
    ...
    writeln!(&module, "use warpish_workflows_types::*;")?;
